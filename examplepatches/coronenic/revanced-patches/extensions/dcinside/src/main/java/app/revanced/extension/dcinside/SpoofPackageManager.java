...
// AUTO-GENERATED from android.jar (API 36) by Gen.java. Do not hand-edit.
...
public final class SpoofPackageManager extends android.content.pm.PackageManager {
    ...
    public <T> T parseAndroidManifest(android.os.ParcelFileDescriptor a0, java.util.function.Function<android.content.res.XmlResourceParser, T> a1) throws java.io.IOException {
        return real.parseAndroidManifest(a0, a1);
    }
