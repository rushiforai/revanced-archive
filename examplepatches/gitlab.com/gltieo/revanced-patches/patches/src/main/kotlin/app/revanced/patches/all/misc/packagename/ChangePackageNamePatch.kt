...
/**
 * Renames the app, which the settings patch reaches through
 * [setOrGetFallbackPackageName]. It carries no name of its own here: ReVanced's own
 * bundle offers this to choose, and a second copy of it in the list would only be a
 * duplicate of theirs.
 */
