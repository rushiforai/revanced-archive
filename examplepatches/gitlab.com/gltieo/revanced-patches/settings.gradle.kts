...
pluginManagement {
    repositories {
        // The patches plugin is published only to GitHub Packages, which refuses
        // anonymous downloads. Without credentials, build it from its own
        // repository with `./gradlew publishToMavenLocal` and it resolves here.
        mavenLocal()
        gradlePluginPortal()
        google()
