...
abstract class PatchesPlugin : Plugin<Project> {
    ...
    private fun Project.configureDependencies() {
        afterEvaluate {
            ...
            val pinnedCli = rootProject.file(".tools/revanced-cli-6.0.0-all.jar")
            require(pinnedCli.isFile) {
                "Missing pinned ReVanced CLI/Patcher API at ${pinnedCli.path}. " +
                    "Run ./bootstrap-tools.ps1 first."
            }
            dependencies.add("implementation", files(pinnedCli))
...
private fun Project.configureJarTask(patchesExtension: PatchesExtension) {
    tasks.withType(Jar::class.java).configureEach {
        ...
        it.manifest.apply {
            ...
            attributes["Timestamp"] = System.getenv("SOURCE_DATE_EPOCH") ?: "0"
